...
const EducationalTripDetails = () => {
    ...
    const popularPackages = [
        {
            ...
            features: ["Wonderla", "Munnar & Vagamon", "Marine Drive DJ Boating"],
        },
        {
            id: 2,
            ...
            features: ["Tech Park Tour", "Museum Visit", "Wonderla"],
        },
        {
            id: 3,
            ...
            features: ["Guna Cave", "Pine Forest", "Campfire"],
        },
        {
            id: 8,
            name: "Goa Party",
            ...
            image: goaPartyImg,
            features: ["Beach Parties", "Water Sports", "Casino"],
        },
    ];
    ...
    const specialPackages = [
        ...
        },
        {
            ...
            features: ["Jeep Safari", "Tiger Safari", "Gokarna Beach"],
        }
    ];
    ...
    return (
        <div className="min-h-screen font-sans relative">
            ...
            <div className="fixed inset-0 z-0 bg-black">
                {/* ... (background images remain visible through the overlay) ... */}
                {/* Image 1: Campfire */}
                <div
...
export default EducationalTripDetails;
