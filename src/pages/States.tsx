...
import madhya from "@/assets/mp hero.jpg";
...
const States = () => {
  ...
  const statesData = [
    { name: "Tamil Nadu", image: tamilnadu, route: "/states/tamilnadu" },
    { name: "Kerala", image: kerala, route: "/states/kerala" },
    { name: "Karnataka", image: karnataka, route: "/states/karnataka" },
    { name: "Goa", image: goa, route: "/states/goa" },
    { name: "Delhi", image: delhi, route: "/states/delhi" },
    { name: "Maharashtra", image: maharashtra, route: "/states/maharashtra" },
    { name: "Andhra Pradesh", image: andhra, route: "/states/andhrapradesh" },
    { name: "Telangana", image: telangana, route: "/states/telangana" },
    { name: "Jammu & Kashmir", image: jammu, route: "/states/jammukashmir" },
    { name: "Puducherry", image: puducherry, route: "/states/puducherry" },
    { name: "Gujarat", image: gujarat, route: "/states/gujarat" },
    { name: "Rajasthan", image: rajasthan, route: "/states/rajasthan" },
    { name: "Ladakh", image: ladakh, route: "/states/ladakh" },
    { name: "Madhya Pradesh", image: madhya, route: "/states/madhyapradesh" },
    { name: "Assam", image: assam, route: "/states/assam" },
    { name: "Andaman & Nicobar", image: andaman, route: "/states/andaman" },
    { name: "Uttar Pradesh", image: uttarpradesh, route: "/states/uttarpradesh" },
    { name: "Bihar", image: bihar, route: "/states/bihar" },
    { name: "Jharkhand", image: jharkhand, route: "/states/jharkhand" },
    { name: "Sikkim", image: sikkim, route: "/states/sikkim" },
    { name: "Meghalaya", image: meghalaya, route: "/states/meghalaya" },
    { name: "Arunachal Pradesh", image: arunachal, route: "/states/arunachal" },
    { name: "Nagaland", image: nagaland, route: "/states/nagaland" },
    { name: "Manipur", image: manipur, route: "/states/manipur" },
    { name: "Himachal Pradesh", image: himachal, route: "/states/himachal" },
    { name: "West Bengal", image: westBengal, route: "/states/west-bengal" },
    { name: "Odisha", image: odisha, route: "/states/odisha" },
    { name: "Chhattisgarh", image: chattisgarh, route: "/states/chhattisgarh" },
    { name: "Punjab", image: punjab, route: "/states/punjab" },
    { name: "Tripura", image: tripura, route: "/states/tripura" },
    { name: "Mizoram", image: mizoram, route: "/states/mizoram" },
    { name: "Haryana", image: haryana, route: "/states/haryana" },
  ];
  ...
  const handleStateClick = (route: string) => {
    navigate(route);
  };

  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-600 via-red-300 to-cyan-300 p-10 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
          {currentStates.map((state, index) => (
            <div
              ...
              onClick={() => handleStateClick(state.route)}
            >
