...
// Image Imports
import ladakhHero from "@/assets/lad hero.jpg";

// Using available assets as placeholders - will use ladakh.jpg for most sections
// In a real scenario, specific images would be sourced for each location
import khardungLa from "@/assets/khardung la.jpg"; // Khardung La Pass
import changLa from "@/assets/changla-pass.jpg"; // Chang La Pass
import pangongTso from "@/assets/Pangong-Tso.jpg"; // Pangong Tso

// Historical Sites
import lehPalace from "@/assets/leh palace.jpg"; // Leh Palace
import thikseyMonastery from "@/assets/thiksey-monastery.jpg"; // Thiksey Monastery
import hemisMonastery from "@/assets/hemis monastery.jpg"; // Hemis Monastery

// Famous Spots
import nubraValley from "@/assets/Nubra-Valley.jpg"; // Nubra Valley
import magneticHill from "@/assets/magnetic hill.jpeg"; // Magnetic Hill
import zanskarValley from "@/assets/Zanskar-Valley.jpg"; // Zanskar Valley

// Resorts & Food - using generic placeholders
import ladakhResort from "@/assets/lak resort.jpg";
import ladakhVeg from "@/assets/lak veg.jpg"; // Thukpa
import ladakhNonVeg from "@/assets/lak non veg.jpg"; // Skyu
import ladakhPicnic from "@/assets/lak pic.jpg"; // Own Food
