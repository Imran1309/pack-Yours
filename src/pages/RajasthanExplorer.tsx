...
// Divine & Spiritual
import rjBrahma from "@/assets/temple_drums_bg.png"; // Proxy
import rjKarni from "@/assets/temple_drums_bg.png"; // Proxy
import rjDilwara from "@/assets/Rajasthan.png"; // Proxy

// Cultural & Royal Hubs
import rjAmber from "@/assets/alila_fort.png"; // Found in list!
import rjCityPalace from "@/assets/Rajasthan.png";
import rjHawa from "@/assets/bg-city.jpg";

// Nature & Unique
import rjTiger from "@/assets/bangalore_tiger_lion_park.png"; // Found in list!
import rjThar from "@/assets/Rajasthan.png"; // Proxy (Desert state image)
import rjNakki from "@/assets/coorg_coffee_hills.png"; // Proxy (Hill station)

// Resorts & Food
import rjUmaid from "@/assets/alila_fort.png"; // Proxy
import rjDalBaati from "@/assets/punjabfood.png"; // Proxy for Veg
import rjLaalMaas from "@/assets/mumbai_chicken_kebabs_1765971162080.png"; // Proxy for Non-Veg
import rjPicnic from "@/assets/ooty_botanical_garden.png"; // Proxy for Picnic
