...
import redFort from "@/assets/red fort.jpg"; // Corrected asset
import indiaGate from "@/assets/india-gate.jpg"; // Corrected asset
import qutubMinar from "@/assets/qutub.jpg"; // Corrected asset
import lotusTemple from "@/assets/lotus.jpg"; // Corrected asset
import akshardham from "@/assets/akshardham.jpg"; // Corrected asset

import choleBhature from "@/assets/veg delhi.jpg"; // Corrected asset
import butterChicken from "@/assets/non veg delhi.jpg"; // Corrected asset
import picnicSpot from "@/assets/own delhi.jpg"; // Corrected asset
