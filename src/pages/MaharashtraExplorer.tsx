...
import gateway from "@/assets/mumbai_gateway_full_view_1765970435408.png"; // Gateway of India
import ajanta from "@/assets/bg-city.jpg"; // Proxy for Ajanta
import raigad from "@/assets/alila_fort.png"; // Proxy for Raigad (Fort)

import siddhivinayak from "@/assets/mumbaitemple.jpg"; // Siddhivinayak Temple
import saibaba from "@/assets/temple_drums_bg.png"; // Proxy for Shirdi
import trimbakeshwar from "@/assets/mumbaitemple.jpg"; // Proxy
...
import seafood from "@/assets/mumbai_fish_fry_crispy_1767287350331.png"; // Seafood Thali

import resort from "@/assets/mumbai_premium_room_sea_view_1765971309015.png"; // Taj Mahal Palace Resort
